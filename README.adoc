...
The [hotspot=7 hotspot=39]`applicationImage` is the name and tag of the container image that you want to use for the container. Update its value to point to your `system` repository URI.
