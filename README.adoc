...
[role=command]
```
sudo podman tag dev.local/system:1.0-SNAPSHOT <aws_account_id>.dkr.ecr.<region>.amazonaws.com/awsguide/system:1.0-SNAPSHOT
```
...
[role=command]
```
sudo podman push <aws_account_id>.dkr.ecr.<region>.amazonaws.com/awsguide/system:1.0-SNAPSHOT
```
