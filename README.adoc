...
The first pod refers to the Open Liberty Operator pod. The next three pods are the `system` microservice pods and the last one is for the Semeru Cloud Compiler server instance . Notice that there are 3 instances of the system service and 1 instance of the Semeru Cloud Compiler server instance . 
