...
:page-description: Learn how to containerize a microservice with Open Liberty InstantOn, deploy the container and enable IBM Semeru Cloud Compiler in your deployment to Amazon Elastic Container Service for Kubernetes (EKS) on Amazon Web Services (AWS).
...
:page-seo-title: Containerizing a Java microservice with Open Liberty InstantOn, deploy your application and enable IBM Semeru Cloud Compiler (SCC) in your deployment to Amazon Elastic Container Service for Kubernetes (EKS) on Amazon Web Services (AWS).
:page-seo-description: A getting started tutorial with examples on how to containerize a Java microservice with Open Liberty InstantOn feature,deploy your application and enable IBM Semeru Cloud Compiler (SCC) to Amazon Elastic Kubernetes Service (EKS) onAmazon Web Services (AWS) by using Amazon Elastic Container Registry (ECR) as a private container registry.
:guide-author: Open Liberty
= Containerizing a microservice with Open Liberty InstantOn and deploying to Amazon Web Services

[.hidden]
NOTE: This repository contains the guide documentation source. To view the guide in published form, view it on the https://openliberty.io/guides/{projectid}.html[Open Liberty website^].

Explore how to containerize a microservice with Open Liberty InstantOn and deploy the container to Amazon Elastic Container Service for Kubernetes (EKS) on Amazon Web Services (AWS).
