...
aws ecr create-repository --repository-name awsguide/inventory/instantOn
```
...
sudo podman tag dev.local/liberty-app-instanton <aws_account_id>.dkr.ecr.<region>.amazonaws.com/awsguide/inventory/instantOn
```
...
sudo podman push <aws_account_id>.dkr.ecr.<region>.amazonaws.com/awsguide/inventory/instantOn
```
